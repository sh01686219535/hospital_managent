...
@section('content')
    ...
    <div class="page-hero bg-image overlay-dark" style="background-image: url({{asset('frontEndAsset')}}/assets/img/bg_image_1.jpg);">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
                        <div class="img-place custom-img-1">
                            <img src="{{asset('frontEndAsset')}}/assets/img/bg-doctor.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
